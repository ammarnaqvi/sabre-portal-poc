...
const AdvancedCalendarSearch = () => {
  useEffect(() => {
    ...
    script.src = "/static/js/portal.v6-uber.js"
    script.onload = function () {
      //eslint-disable-next-line
      APIMaticDevPortal.show({
        container: "apimatic-widget",
        codegenApiRoutes: {
          docsgen: "/static/docs/{template}.json",
          codegen: "/static/sdks/{template}.zip",
          transform: "/static/exports/{format}",
        },
        apiKey: "xxxx",
        baseUrl: "./",
        enableExport: false,
  ...
  return (
    <Layout>
      ...
      <div
        id="apimatic-widget"
        style="height: calc(100% - 56px); width: 100%; position: relative;"
      ></div>
    </Layout>
  )
}
